...
/**
 * Provides the local service interface for BookDetail. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author linhpksw
 * @see BookDetailLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BookDetailLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>guestbook.service.impl.BookDetailLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the book detail local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BookDetailLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public BookDetail addBookDetail(
			...
			String isbn, int status, ServiceContext serviceContext)
	...
	public BookDetail deleteBookDetail(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<BookDetail> searchBookDetailsByKeywords(
		String keywords, int start, int end, OrderByComparator<BookDetail> obc);
