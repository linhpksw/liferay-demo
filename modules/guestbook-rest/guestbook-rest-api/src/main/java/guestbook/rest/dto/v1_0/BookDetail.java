 ...
 */
@Generated("")
@GraphQLName("BookDetail")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "BookDetail")
public class BookDetail implements Serializable {

	public static BookDetail toDTO(String json) {
		return ObjectMapperUtil.readValue(BookDetail.class, json);
	}

	public static BookDetail unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(BookDetail.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "guestbook.rest.dto.v1_0.BookDetail",
		name = "x-class-name"
	)
